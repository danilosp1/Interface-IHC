    ...
    return (
        <main className="flex flex-row h-ful min-h-screen items-center justify-center">
            ...
            <div className="z-10 w-full lg:w-[60%] 2xl:w-[50%] flex flex-col items-center justify-center h-full">
                ...
                <div className="text-center text-black text-2xl lg:text-4xl font-normal w-[80%] 2xl:w-[50%] my-6 mb-8">
                    A UFSCar possui serviços gratuitos de atendimento psicológico
                </div>
                <div className="text-center text-black text-2xl lg:text-4xl font-bold my-2">
                    <div className="font-normal">Atendimento psicológico da Ufscar:</div>
                    <div>https://www.deacear.ufscar.br/saude-mental/agendar-psi</div>
                </div>
                <div className="text-center text-black text-2xl lg:text-4xl font-bold my-2">
                    <div className="font-normal">Projeto Y:</div>
                    <div>link ou telefone</div>
                </div>
                <div className="text-center text-black text-2xl lg:text-4xl font-bold my-2 mb-12">
                    <div className="font-normal">Projeto Z:</div>
                    <div>link ou telefone</div>
                </div>
